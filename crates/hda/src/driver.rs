...
impl<'a> HdaOutput<'a> {
    ...
    pub unsafe fn play_pcm(
        ...
        unsafe {
            ...
            self.unmute_output_path(codec_addr, dac_nid, pin_nid);
        }
    ...
    unsafe fn unmute_output_path(&mut self, codec_addr: u8, dac_nid: u8, pin_nid: u8) {
        debug!(
